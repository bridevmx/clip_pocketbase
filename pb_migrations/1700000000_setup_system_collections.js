...
migrate((app) => {
    ...
    try {
        ...
        const colMigrations = new Collection({
            ...
            fields: [
                ...
                { name: "up_code", type: "text", required: true },
                { name: "down_code", type: "text" },
    ...
    try {
        app.delete(app.findCollectionByNameOrId("z_system_settings_do_not_touch"));
    } catch (_) {}
    try {
        app.delete(app.findCollectionByNameOrId("z_system_hooks_do_not_touch"));
    } catch (_) {}
    try {
        app.delete(app.findCollectionByNameOrId("z_system_migrations_do_not_touch"));
    } catch (_) {}
});
